...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BioCascadeModeller_treatmenttech', (
            ...
            ('model_pic', self.gf('django.db.models.fields.files.ImageField')(default='pic_folder/None/no-img.jpg', max_length=100)),
        ))
    ...
    models = {
        ...
        u'BioCascadeModeller.treatmenttech': {
            ...
            'desc': ('django.db.models.fields.TextField', [], {'default': "'test'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model_pic': ('django.db.models.fields.files.ImageField', [], {'default': "'pic_folder/None/no-img.jpg'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
