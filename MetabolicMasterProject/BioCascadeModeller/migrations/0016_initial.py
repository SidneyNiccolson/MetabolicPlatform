...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BioCascadeModeller_wasteparameters', (
            ...
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BioCascadeModeller.Waste'])),
        ))
    ...
    models = {
        ...
        u'BioCascadeModeller.wasteparameters': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['BioCascadeModeller.Waste']"}),
