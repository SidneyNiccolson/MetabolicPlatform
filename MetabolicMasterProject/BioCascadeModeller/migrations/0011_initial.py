...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'BioCascadeModeller_wasteparameters', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('parameters', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BioCascadeModeller.Parameters'])),
            ('waste_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['BioCascadeModeller.Waste'])),
        ))
    ...
    models = {
        ...
        u'BioCascadeModeller.wasteparameters': {
            ...
            'quantity': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
